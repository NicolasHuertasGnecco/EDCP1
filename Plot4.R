{
        ...
        plot(datesR$Voltage~datesR$DT,ylab="Voltage",type="l")
        ...
        legend("topright",c("S1","S2","S3"),lty = c(1,1,1),col = c("black","blue","red"),bty="n",cex=0.75)
        plot(datesR$Global_reactive_power~datesR$DT,ylab="Global Reactive power",type="l")
        dev.off()
}